...
\item Let the point moving point be $S$ and the directrix equation be $\vec{n}^\top\vec{x}=0$.\\
...
\end{align}
Equation 24 is the locus of the moving point which is the quadratic form of parabola.\\
